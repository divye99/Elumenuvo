    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        ...
        <Link href="/admin/reviews" style={{ background: "#fff", border: "1px solid #E8EBF1", borderRadius: 14, padding: 20, position: "relative" }}>
          {pendingReviews > 0 && <span style={{ position: "absolute", top: 14, right: 14, fontSize: 12, fontWeight: 700, color: "#fff", background: "#E0612A", borderRadius: 20, padding: "2px 9px" }}>{pendingReviews}</span>}
        ...
        <Link href="/admin/customers" style={{ background: "#fff", border: "1px solid #E8EBF1", borderRadius: 14, padding: 20 }}>
          ...
          <div style={{ fontSize: 13, color: "#4E5BDC", fontWeight: 600, marginTop: 6 }}>Portfolios · predicted reorders →</div>
        </Link>
        ...
        <Link href="/admin/metals" style={{ background: "#fff", border: "1px solid #E8EBF1", borderRadius: 14, padding: 20 }}>
          ...
          <div style={{ fontSize: 28, fontWeight: 700 }}>🥉</div>
          <div style={{ fontSize: 13, color: "#4E5BDC", fontWeight: 600, marginTop: 6 }}>Copper price console · enquiries →</div>
        </Link>
        <Link href="/admin/signups" style={{ background: "#fff", border: "1px solid #E8EBF1", borderRadius: 14, padding: 20 }}>
          ...
          <div style={{ fontSize: 28, fontWeight: 700 }}>👥</div>
          <div style={{ fontSize: 13, color: "#4E5BDC", fontWeight: 600, marginTop: 6 }}>Registered accounts →</div>
        </Link>
