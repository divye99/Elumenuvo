            ...
            <div key={it.id} style={{ display: "flex", gap: 14, alignItems: "center", padding: "14px 16px", borderTop: i ? "1px solid #F0F2F6" : undefined }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: 12, color: "#8A93A6" }}>
                  {it.brand} · {fmt(baseExGst(unitPriceFor(it.price, it.qty), it.cat, it.gstRate))}+GST/{it.unit}
              ...
              <div style={{ width: 90, textAlign: "right", fontFamily: GROTESK, fontWeight: 700, fontSize: 14 }}>{fmt(baseExGst(unitPriceFor(it.price, it.qty), it.cat, it.gstRate) * it.qty)}</div>
