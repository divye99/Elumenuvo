  ...
  return (
    <StoreChrome>
      <main style={{ maxWidth: 820, margin: "0 auto", padding: "40px 28px 72px" }}>
        <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: "1.4px", textTransform: "uppercase", color: "#1D2F8A", marginBottom: 10 }}>{kicker}</div>
        ...
        <p style={{ fontSize: 12.5, color: "#8A93A6", marginTop: 26 }}>
          Questions? Write to <a href="mailto:info@elumenuvo.com" style={{ color: "#1D2F8A", fontWeight: 600 }}>info@elumenuvo.com</a> or call{" "}
          <a href="tel:+919818821175" style={{ color: "#1D2F8A", fontWeight: 600 }}>+91 98188 21175</a>.
        </p>
      </main>
    </StoreChrome>
  );
