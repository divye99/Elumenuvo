  ...
  return (
    <form action={formAction} style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
      ...
      <button
        type="submit"
        disabled={pending}
        style={{ flex: "1 1 100%", background: "#1D2F8A", color: "#fff", fontSize: 14.5, fontWeight: 700, border: "none", borderRadius: 11, padding: "13px 22px", cursor: pending ? "wait" : "pointer", opacity: pending ? 0.7 : 1 }}
      >
